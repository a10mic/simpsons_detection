...
class TFAnnotation:
    def __init__(self):
        # initialize the bounding box + label lists & all other attributes
        # required to build tfrecord
        self.xMins = []
        self.xMaxs = []
        self.yMins = []
        self.yMaxs = []
        ...
        # initialize the additional variables such as image, spatial dimensions,
        # encoding and file name
        self.image = None
        self.width = None
        self.height = None
        self.encoding = None
    ...
    def build(self):
        # encode attributes according to their tensorflow encoding function
