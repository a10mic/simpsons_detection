...
# build the path to annotations file
ANNOT_PATH = os.path.sep.join([BASE_PATH, "annotation.csv"])
...
CLASSES = {"abraham_grampa_simpson": 1, "bart_simpson": 2, "charles_montgomery_burns": 3}
